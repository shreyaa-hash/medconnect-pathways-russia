...
const universitiesData = [
  ...
  },
  {
    ...
    description: "Russia's oldest and most prestigious medical university, a global leader in medical education and research.",
    ...
    hostel: "Yes",
    detailedInfo: [
      "Sechenov University is the oldest medical school in Russia and one of the most respected medical institutions in the world.",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "Students benefit from rotations at some of Russia's best teaching hospitals.",
    ],
  ...
  },
  {
    ...
    description: "One of Russia's finest medical schools located in the cultural capital, known for its strong clinical programs.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Saratov State Medical University is one of the oldest medical schools in Russia with over a century of excellence.",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "The university provides a quality medical education at one of the most competitive tuition rates in Russia.",
  ...
  },
  {
    ...
    description: "One of the oldest dedicated medical universities in Russia with a strong tradition of medical excellence.",
    ...
    detailedInfo: [
      "Kazan State Medical University is one of the oldest dedicated medical schools in Russia, established in 1814.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Novosibirsk State Medical University is the premier medical institution in Siberia and one of Russia's top medical schools.",
      "Located in Russia's third-largest city, it offers access to advanced research facilities and clinical centers.",
      "The university has strong ties to the Siberian Branch of the Russian Academy of Sciences.",
    ],
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Siberian State Medical University in Tomsk is one of the oldest and most prestigious medical schools in Russia.",
      "Tomsk is known as the 'student city' of Russia, with a vibrant academic community.",
  ...
  },
  {
    ...
    established: 1930,
    ranking: "Top 15 Medical",
    description: "A leading medical university in Southern Russia with excellent clinical training and modern facilities.",
    ...
    hostel: "Yes",
    detailedInfo: [
      "Rostov State Medical University is one of the top medical schools in Southern Russia.",
      "Located in Rostov-on-Don, students enjoy a warmer climate compared to most Russian cities.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "North Ossetian State Medical Academy offers one of the most affordable MBBS programs in Russia.",
  ...
  },
  {
    ...
    description: "A respected medical university in Southern Russia with modern facilities and a diverse student body.",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "Yekaterinburg is Russia's fourth-largest city, offering excellent infrastructure and opportunities.",
      "The university has strong research programs and modern clinical training facilities.",
    ],
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Voronezh State Medical University is named after N.N. Burdenko, one of the founders of Russian neurosurgery.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Privolzhsky Research Medical University is one of the leading medical research institutions in Russia.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Kuban State Medical University is located in Krasnodar, one of the warmest and most pleasant cities in Russia.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Dagestan State Medical University offers some of the most affordable medical programs in Russia.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Yaroslavl State Medical University is located in one of Russia's beautiful Golden Ring cities.",
      "The university offers quality medical education at competitive tuition rates.",
      "Students experience Russia's rich cultural heritage while pursuing their medical studies.",
    ],
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "Cheboksary is consistently ranked as one of Russia's safest and cleanest cities.",
  ...
  },
  {
    ...
    established: 1972,
    ranking: "Recognized",
    description: "An affordable university in one of Russia's most beautiful small cities.",
  ...
  },
  {
    ...
    description: "The leading medical university in Russia's Far East with unique Asia-Pacific connections.",
    ...
    hostel: "Yes",
    detailedInfo: [
      "Pacific State Medical University is the premier medical institution in Russia's Far East.",
  ...
  },
  {
    ...
    detailedInfo: [
      ...
      "Tyumen is one of Russia's fastest-developing cities with excellent modern infrastructure.",
  ...
  },
  {
    ...
    detailedInfo: [
      "Far Eastern Federal University has one of Russia's most modern campuses, built on Russky Island.",
  ...
  },
  {
    ...
    established: 1915,
    ranking: "QS Ranked",
    description: "One of Russia's leading federal universities with a strong medical institute.",
    ...
    hostel: "Yes",
    detailedInfo: [
      "Southern Federal University is one of Russia's leading federal universities with a well-established medical institute.",
  ...
  },
  {
    ...
    hostel: "Yes",
    detailedInfo: [
      "Kabardino-Balkarian State University offers one of the most affordable medical programs in Russia.",
  ...
  },
  {
    ...
    established: 1932,
    ranking: "Recognized",
    description: "A historic university in one of Russia's oldest cities offering medical programs.",
    highlights: ["Historic City", "Affordable", "NMC Approved"],
    tuitionFee: "$3,000 - $4,000/year",
    duration: "6 Years",
    medium: "English",
    hostel: "Yes",
    detailedInfo: [
      "Pskov State University is located in one of Russia's oldest and most historic cities.",
  ...
  },
  {
    ...
    established: 1957,
    ranking: "Recognized",
    description: "A national research university with an affordable medical institute in central Russia.",
